...
public abstract class Pieces {
    ...
    public abstract void legalMoves(int row, int col);
    public abstract void legalTakes(int row, int col);
    public abstract void drawPiece(PieceColor color, Label label);
    abstract boolean isChecking();
    public static boolean isOutOfBoard(int row, int col) {
        return row > 7 || row < 0 || col > 7 || col < 0;
    }
    public abstract int calculateMoveStrength(Coordinates<Integer, Integer> move);
