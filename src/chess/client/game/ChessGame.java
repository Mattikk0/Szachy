...
import chess.client.bot.ChessBotLvl0;
import chess.client.bot.ChessBotLvl1;
import chess.client.ui.board.Board;
import chess.client.ui.menu.EndMenu;
import chess.client.ui.menu.ErrorMenu;
...
public class ChessGame {
    ...
    public void showLegalMoves(Pieces piece, int row, int col) {
    ...
    public void move(int row, int col, Pieces piece, int prev_row, int prev_col, PieceColor color, GameState player) {
    ...
    public static boolean checkIfGameOver(PieceColor king_color) {
        for (Pieces[] row : Board.game_board) {
            for (Pieces piece : row) {
    ...
    public static boolean checkIfCheckmate(PieceColor king_color) throws IOException, InterruptedException {
    ...
    public static boolean checkIfStalemate(PieceColor king_color) throws IOException, InterruptedException {
        King king = (King) Board.game_board[Pieces.findFigure(King.class, king_color).getX()][Pieces.findFigure(King.class, king_color).getY()];
    ...
    public static long[][][] allCombinations() {
    ...
    public static long hashBoardToNumber() {
        int pieceValue = 0;
        int squareIndex = 0;
        long hash = 0;
        for (int i = 0; i < 8; i++) {
    ...
    public void loadGameFromFile(String file_name) throws IOException, InterruptedException {
    ...
    public void promotion(Pieces newPiece, int row, int col, Pawn oldPawn) {
    ...
    public boolean checkForPromotion(Pieces piece){
        if(piece instanceof Pawn){
